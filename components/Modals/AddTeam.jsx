...
const AddTeam = ({ addShown, setAddShown }) => {
    ...
    const handleAddTeam = () => {
        ...
        if (teams.length === 0) // if no teams, first team id 1
            ...
            newId = maxIdObject.id + 1; // else generate new Id
        }
        const newTeam = {
            id: newId,
            players: [],
            ...
            <View style={addTeamStyles.overlay}>
                <View style={addTeamStyles.mainContainer}>
                    ...
                    <View style={addTeamStyles.btnContainer}>
                        <Pressable style={addTeamStyles.addBtnStyles} onPress={handleAddTeam}>
                            <Text>{"Add Team"}</Text>
                        </Pressable>
                        <Pressable style={addTeamStyles.cancelBtnStyles} onPress={() => setAddShown(false)}>
                            <Text>Cancel</Text>
                        </Pressable>
                    </View>
                </View>
